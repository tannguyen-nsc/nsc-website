...
Options::addGlobal('TimberDynamicResize', [
    [
        'label' => __('Dynamic Image Generation', 'NscSoftware'),
        'instructions' => __('Generate images on-the-fly, when requested, not during initial render.', 'NscSoftware'),
    ...
    [
        'label' => __('Relative Upload Path', 'NscSoftware'),
        'instructions' => __('If Timber Dynamic Resize cannot resolve the path to images correctly, set the relative upload path manually.', 'NscSoftware'),
