...
/**
 * Case study single: flexible components (Hero, Instruction, Quote, Contact, Main content, Related).
    ...
    ACFComposer::registerFieldGroup([
        ...
        'fields' => [
            [
                ...
                'instructions' => __('Add Hero, Instruction, Quote, Contact, Main content, and Related case studies. Order matches the public case study detail page.', 'NscSoftware'),
                'layouts' => [
                    ...
                    Components\NSCCaseStudyRelated\getACFLayout(),
                ],
            ],
        ],
        'location' => [
