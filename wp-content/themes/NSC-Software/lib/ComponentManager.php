...
class ComponentManager
{
    ...
    public function registerComponent(string $componentName, ?string $componentPath = null)
    {
        ...
        $componentPath = trailingslashit(apply_filters('NscSoftware/componentPath', $componentPath, $componentName));

        // Add component to internal list (array).
        $this->add($componentName, $componentPath);

        do_action('NscSoftware/registerComponent', $componentName);
        do_action("NscSoftware/registerComponent?name={$componentName}", $componentName);
