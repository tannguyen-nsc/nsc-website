...
namespace NscSoftware\Components\NSCBlockAiInfo;
...
function getACFLayout()
{
    return [
        'name' => 'nscBlockAiInfo',
        'label' => __('NSC Block: AI Info', 'NscSoftware'),
        'sub_fields' => [
            [
            ...
            [
                'label' => __('Image (left column)', 'NscSoftware'),
                'name' => 'image',
                'type' => 'image',
                'preview_size' => 'medium',
                'return_format' => 'array',
            ...
            [
                'label' => __('Content items', 'NscSoftware'),
                'name' => 'items',
                'type' => 'repeater',
                'min' => 1,
                'layout' => 'block',
