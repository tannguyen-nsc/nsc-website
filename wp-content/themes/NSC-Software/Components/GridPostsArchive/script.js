...
export default function (el) {
  ...
  async function onLoadMore (e) {
    ...
    try {
      ...
      const posts = html.querySelector('NSC-Software-component[name="GridPostsArchive"] [data-ref="posts"]')
      const pagination = html.querySelector('NSC-Software-component[name="GridPostsArchive"] [data-ref="pagination"]')
