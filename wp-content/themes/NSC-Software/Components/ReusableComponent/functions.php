...
namespace NscSoftware\Components\ReusableComponent;

function getACFLayout()
{
    return [
        'name' => 'ReusableComponent',
        'label' => sprintf('%1$s <i class="dashicons dashicons-controls-repeat"></i>', __('Reusable', 'NscSoftware')),
        'sub_fields' => [
            [
                'label' => __('Select Reusable Component', 'NscSoftware'),
                'name' => 'reusableComponent',
                'type' => 'post_object',
                'post_type' => [
                    'reusable-components'
