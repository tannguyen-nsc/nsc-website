/* globals NscSoftwareData, FeatureFlexibleContentExtension */
...
function showComponentScreenshot (layout, wrapper) {
  ...
  img.classList.add('NSC-SoftwareComponentScreenshot-previewImageLarge')
  img.src = image
...
function hideComponentScreenshot (wrapper) {
  const wrapperContainer = wrapper.querySelector('.NSC-SoftwareComponentScreenshot-imageWrapper')
